...
namespace espnow {
    ...
    // NVS (Non-Volatile Storage) is used for saving configuration data, Wi-Fi credentials, and RF calibration data across power cycles.
  ...
  /// @brief Ensure that the broadcast peer S3 is added, as it's required for ESP-NOW broadcast.
